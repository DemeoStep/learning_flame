...
mixin _$GameStatsState {
 ...
 bool get isGameOver; bool get isGameStarted; int get score; int get clipSize; int get lives; int get asteroidCount; int get mojaherCount; int get asteroidSpeed; int get cannonSpeed; int get cannonReloadTime; int get planeSpeed; DateTime get gameStartTime;
...
@useResult
$Res call({
 bool isGameOver, bool isGameStarted, int score, int clipSize, int lives, int asteroidCount, int mojaherCount, int asteroidSpeed, int cannonSpeed, int cannonReloadTime, int planeSpeed, DateTime gameStartTime
});
