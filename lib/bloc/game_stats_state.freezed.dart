...
mixin _$GameStatsState {
 ...
 bool get isGameOver; bool get isGameStarted; int get score; int get clipSize; int get lives; int get asteroidCount; int get asteroidSpeed; int get cannonSpeed; int get cannonReloadTime; int get planeSpeed; DateTime get gameStartTime;
...
@override
int get hashCode => Object.hash(runtimeType,isGameOver,isGameStarted,score,clipSize,lives,asteroidCount,asteroidSpeed,cannonSpeed,cannonReloadTime,planeSpeed,gameStartTime);

@override
String toString() {
  return 'GameStatsState(isGameOver: $isGameOver, isGameStarted: $isGameStarted, score: $score, clipSize: $clipSize, lives: $lives, asteroidCount: $asteroidCount, asteroidSpeed: $asteroidSpeed, cannonSpeed: $cannonSpeed, cannonReloadTime: $cannonReloadTime, planeSpeed: $planeSpeed, gameStartTime: $gameStartTime)';
}
...
@useResult
$Res call({
 bool isGameOver, bool isGameStarted, int score, int clipSize, int lives, int asteroidCount, int asteroidSpeed, int cannonSpeed, int cannonReloadTime, int planeSpeed, DateTime gameStartTime
});
