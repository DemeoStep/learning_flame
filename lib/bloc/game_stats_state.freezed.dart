...
mixin _$GameStatsState {
 ...
 bool get isGameOver; bool get isGameStarted; int get gameStartTimestamp; int get score; int get lives; int get planeSpeed; int get fireAtOnce; int get cannonSpeed; int get cannonReloadTime; int get asteroidCount; int get asteroidSpeed;
...
@override
int get hashCode => Object.hash(runtimeType,isGameOver,isGameStarted,gameStartTimestamp,score,lives,planeSpeed,fireAtOnce,cannonSpeed,cannonReloadTime,asteroidCount,asteroidSpeed);

@override
String toString() {
  return 'GameStatsState(isGameOver: $isGameOver, isGameStarted: $isGameStarted, gameStartTimestamp: $gameStartTimestamp, score: $score, lives: $lives, planeSpeed: $planeSpeed, fireAtOnce: $fireAtOnce, cannonSpeed: $cannonSpeed, cannonReloadTime: $cannonReloadTime, asteroidCount: $asteroidCount, asteroidSpeed: $asteroidSpeed)';
}
...
@useResult
$Res call({
 bool isGameOver, bool isGameStarted, int gameStartTimestamp, int score, int lives, int planeSpeed, int fireAtOnce, int cannonSpeed, int cannonReloadTime, int asteroidCount, int asteroidSpeed
});
...
/// Create a copy of GameStatsState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isGameOver = null,Object? isGameStarted = null,Object? gameStartTimestamp = null,Object? score = null,Object? lives = null,Object? planeSpeed = null,Object? fireAtOnce = null,Object? cannonSpeed = null,Object? cannonReloadTime = null,Object? asteroidCount = null,Object? asteroidSpeed = null,}) {
...
class _GameStatsState implements GameStatsState {
   _GameStatsState({this.isGameOver = false, this.isGameStarted = false, this.gameStartTimestamp = 0, this.score = 0, this.lives = 3, this.planeSpeed = 100, this.fireAtOnce = 3, this.cannonSpeed = 100, this.cannonReloadTime = 200, this.asteroidCount = 0, this.asteroidSpeed = 100});
...
/// Create a copy of GameStatsState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isGameOver = null,Object? isGameStarted = null,Object? gameStartTimestamp = null,Object? score = null,Object? lives = null,Object? planeSpeed = null,Object? fireAtOnce = null,Object? cannonSpeed = null,Object? cannonReloadTime = null,Object? asteroidCount = null,Object? asteroidSpeed = null,}) {
